...
| Live desktop remains usable | Capture changes reflected while covered; clear side transparent; mouse events pass through |
| No recursive capture | Own application excluded from ScreenCaptureKit filter; live visual check |
| Disconnect and stale input | Deterministic lifecycle tests plus unplug/reconnect hardware validation |
...
5. Move pointer and scroll in another application while one side is covered.
