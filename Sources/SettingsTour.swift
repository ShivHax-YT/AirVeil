...
enum SettingsTourStep: String, CaseIterable, Identifiable {
    ...
    var detail: String {
        ...
        case .camera: return "Optional camera assistance checks your screen direction and can restore it after confirmed reinsertion. Refresh direction starts a check; Stop check cancels it. Face light is offered in low light. Images stay local and are discarded."
