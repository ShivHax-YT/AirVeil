...
**Source version: 0.15.0, build 20.** This README describes the current working source. The download link above still points to the published **0.14.0 RC 1**; the new permission cards and behavior below require a 0.15.0 source build until its release is published.
